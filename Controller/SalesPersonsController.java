...
import com.example.capstone2updated.Service.SalesPersonService;
...
public class SalesPersonsController {
    ...
    @GetMapping("/@me")
    public ResponseEntity<HashMap<String, Object>> viewMyDetails(@AuthenticationPrincipal User user) {
        return ResponseEntity.ok(salesPersonService.viewMyDetails(user));
    }
